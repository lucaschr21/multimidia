...
import { FiMic, FiZap, FiDownload } from "react-icons/fi";
import { BsSoundwave } from "react-icons/bs";
import { FaRegSmile } from "react-icons/fa";

function SecaoAudio() {
  const iconeVozes = <FaRegSmile style={{ color: "#808080" }} />;
  const iconeVelocidade = <FiZap style={{ color: "#f59e0b" }} />;
  const iconeDownload = <FiDownload style={{ color: "#0284c7" }} />;
    ...
    <div className="d-flex flex-column gap-3">
      ...
      >
        <div className="card-body p-5 text-center d-flex flex-column align-items-center">
          ...
          <Link
            to="/narracao" // Linka para a nova rota
